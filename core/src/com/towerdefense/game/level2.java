...
public class level2 extends ScreenAdapter{
	...
	Stage pauseMenu;
	Stage Lost;
	public level2() throws FileNotFoundException, IOException {
		
		this.batch = towerDefense.batch;
		map = new Map("level02.txt");
		monsterwave = new Monster[5];
		monsterwave[4] = new SekiroDieTwice(map.getTile(2, 14),map,64,64);
		monsterwave[0] = new Giant(map.getTile(2, 14),map,64,64);
		monsterwave[1] = new Fugu(map.getTile(2, 14),map,64,64);
		monsterwave[2] = new Squirrel(map.getTile(2,14),map,64,64);
		monsterwave[3] = new Onion(map.getTile(2, 14),map,64,64); 
