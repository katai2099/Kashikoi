...
public class level4 extends ScreenAdapter{
	...
	public level4() throws FileNotFoundException, IOException {
		...
		monsterwave[4] = new SekiroDieTwice(map.getTile(0, 2),map,64,64);
		monsterwave[0] = new Giant(map.getTile(0, 2),map,64,64);
		monsterwave[1] = new Fugu(map.getTile(0, 2),map,64,64);
		monsterwave[2] = new Squirrel(map.getTile(0,2),map,64,64);
		monsterwave[3] = new Onion(map.getTile(0, 2),map,64,64); 
		monsterwave[9] = new SekiroDieTwice(map.getTile(2, 14),map,64,64);
		monsterwave[5] = new Giant(map.getTile(2, 14),map,64,64);
		monsterwave[6] = new Fugu(map.getTile(2,14),map,64,64);
